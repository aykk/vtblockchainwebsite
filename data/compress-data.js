...
// Read input files
const marketcapData = JSON.parse(fs.readFileSync(path.join(__dirname, 'marketcap-results.json'), 'utf8'));
const transfersData = JSON.parse(fs.readFileSync(path.join(__dirname, 'transfers-results.json'), 'utf8'));
