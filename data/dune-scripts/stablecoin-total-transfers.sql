-- Stablecoin Total Transfers Query (EVM)
-- This query calculates aggregate transfer statistics for stablecoins across EVM chains.
-- Data is from the last 7 days (adjustable via the days parameter).
